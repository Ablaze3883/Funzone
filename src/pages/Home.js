        ...
        <div className="md:mx-28 mx-4 text-fontColor pt-8 md:pt-16 pb-12">
            ...
            <div className='md:grid md:grid-cols-2 items-center'>
                <div className=''>
                    ...
                    <p className='text-xl md:text-2xl py-4 tracking-wider'>FunZone is a web application that allows you to enter into the 3D world of the game Escape Room. Here users need to enter the room and see the 3D world of the game. The user can also interact with the 3D world and need to find the exit with the correct combination of the keys provided by the game by decoding the riddles.</p>
